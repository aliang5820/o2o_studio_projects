...
public class SDTitleSimple extends LinearLayout implements OnClickListener
{
	...
	private void init()
	{
		...
		this.addView(mView, SDViewUtil.getLayoutParamsLinearLayoutMM());
	...
	protected void changeViewOnLayoutChange()
	{
		...
		int maxMiddleWidth = ((SDViewUtil.getViewWidth(this) / 2) - width) * 2;

		if (mWidthMiddle > maxMiddleWidth)
		{
			SDViewUtil.setViewWidth(mLlMiddle, maxMiddleWidth);
		} else
		{
	...
	{
		SDViewUtil.setViewHeight(mView, height);
		return this;
	}
