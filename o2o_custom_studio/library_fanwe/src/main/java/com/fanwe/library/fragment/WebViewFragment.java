...
public class WebViewFragment extends SDBaseFragment implements SDTitleListener {
    ...
    private void initWebView() {
        ...
        mWeb.setListenerWebViewClient(new WebViewClientListener() {
            @Override
        ...
        mWeb.setListenerWebChromeClient(new WebChromeClientListener() {
            @Override
    ...
    protected void addJavascriptInterface() {
        mWeb.addJavascriptInterface(new JavaScriptInterface(), "android");
    }
