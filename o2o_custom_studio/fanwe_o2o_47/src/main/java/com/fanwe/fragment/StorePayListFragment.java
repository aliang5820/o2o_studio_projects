...
import com.fanwe.adapter.StorePayListAdapter;
...
import com.fanwe.model.Stores_pay_indexActModel;
 ...
 * 
 */
public class StorePayListFragment extends BaseFragment
{
	/** 大分类id(int) */
	...
	private StorePayListAdapter mAdapter = null;
	...
	{
		mAdapter = new StorePayListAdapter(mListModel, getActivity());
	...
	private void requestData(final boolean isLoadMore)
	{
		...
		SDRequestCallBack<Stores_pay_indexActModel> handler = new SDRequestCallBack<Stores_pay_indexActModel>()
		{
