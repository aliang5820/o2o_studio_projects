 ...
 * 
 */
public class YouhuiDetailCommentFragment extends YouhuiDetailBaseFragment
{
	...
	private void bindData()
	{
		...
		List<CommentModel> listModel = mYouhuiModel.getDp_list();
	...
	private void clickMoreComment()
	{
		...
		intent.putExtra(CommentListActivity.EXTRA_TYPE, CommentType.YOUHUI);
