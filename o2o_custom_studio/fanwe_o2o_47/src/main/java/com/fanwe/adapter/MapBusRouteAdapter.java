...
public class MapBusRouteAdapter extends SDSimpleAdapter<MapBusRouteModel>
{
	...
	@Override
	public void bindData(int position, View convertView, ViewGroup parent, MapBusRouteModel model)
	{
