...
public class MapWalkingRouteAdapter extends SDSimpleAdapter<MapWalkingRouteModel>
{
	...
	public MapWalkingRouteAdapter(List<MapWalkingRouteModel> listModel, Activity activity)
	{
	...
	@Override
	public void bindData(int position, View convertView, ViewGroup parent, MapWalkingRouteModel model)
	{
