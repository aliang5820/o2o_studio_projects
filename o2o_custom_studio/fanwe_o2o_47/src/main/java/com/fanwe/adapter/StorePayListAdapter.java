...
public class StorePayListAdapter extends SDSimpleAdapter<StoreModel>
{

	public StorePayListAdapter(List<StoreModel> listModel, Activity activity)
	{
	...
	{
		return R.layout.item_store_pay_list;
	}
	...
	public void bindData(int position, View convertView, ViewGroup parent, final StoreModel model)
	{
		...
		TextView tv_promote = get(R.id.tv_promote, convertView);
		...
		SDViewBinder.setTextView(tv_promote, model.getPromote_description());
