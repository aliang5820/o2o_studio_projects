...
import com.fanwe.library.utils.ObserverManager;
...
public class SDBaseActivity extends FragmentActivity implements SDEventObserver, OnClickListener
{
	...
	private ObserverManager<SDActivityDispatchTouchEventListener> mObserverManagerDispatchTouchEventListener = new ObserverManager<SDActivityDispatchTouchEventListener>();
	private ObserverManager<SDActivityDispatchKeyEventListener> mObserverManagerDispatchKeyEventListener = new ObserverManager<SDActivityDispatchKeyEventListener>();

	public ObserverManager<SDActivityDispatchTouchEventListener> getObserverManagerDispatchTouchEventListener()
	{
		return mObserverManagerDispatchTouchEventListener;
	}

	public ObserverManager<SDActivityDispatchKeyEventListener> getObserverManagerDispatchKeyEventListener()
	{
		return mObserverManagerDispatchKeyEventListener;
	}
	...
	public boolean dispatchTouchEvent(MotionEvent ev)
	{
		...
		List<SDActivityDispatchTouchEventListener> list = mObserverManagerDispatchTouchEventListener.getObserver();
	...
	public boolean dispatchKeyEvent(KeyEvent event)
	{
		...
		List<SDActivityDispatchKeyEventListener> list = mObserverManagerDispatchKeyEventListener.getObserver();
