...
public class SDTabCorner extends SDViewBase
{
	...
	{
		getViewConfig(mTvTitle).setmTextColorNormal(mLibraryConfig.getmMainColor());
	...
	public void reverseDefaultConfig()
	{
		...
		getViewConfig(mTvTitle).setmTextColorSelected(mLibraryConfig.getmMainColor());
	...
	private SDDrawable createDefaultBackgroundNormal()
	{
		...
		drawableNormal.strokeColor(mLibraryConfig.getmMainColor());
		drawableNormal.strokeWidthAll(mLibraryConfig.getmStrokeWidth());
		drawableNormal.cornerAll(mLibraryConfig.getmCornerRadius());
	...
	private SDDrawable createDefaultBackgroundSelected()
	{
		...
		drawableSelected.color(mLibraryConfig.getmMainColor());
		drawableSelected.strokeColor(mLibraryConfig.getmMainColor());
		drawableSelected.strokeWidthAll(mLibraryConfig.getmStrokeWidth());
		drawableSelected.cornerAll(mLibraryConfig.getmCornerRadius());
	...
	{
		SDDrawable drawableNormal = new SDDrawable();
		drawableNormal.color(mLibraryConfig.getmMainColor());
