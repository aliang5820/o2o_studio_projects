...
public class CustomWebView extends WebView
{
	...
	protected void initSettings(WebSettings settings)
	{
		...
		us = us + " fanwe_app_sdk" + " sdk_type/android" + " sdk_version_name/" + SDPackageUtil.getVersionName() + " sdk_version/" + SDPackageUtil.getVersionCode()
				+ " sdk_guid/" + SDPackageUtil.getDeviceId() + " screen_width/" + SDViewUtil.getScreenWidth() + " screen_height/" + SDViewUtil.getScreenHeight();
		settings.setUserAgentString(us);
	}
