...
public class SDTabCornerText extends SDTabCorner
{
	...
	{
		getViewConfig(mTvTitle).setTextColorNormal(mLibraryConfig.getmMainColor()).setTextColorSelected(Color.WHITE);
	...
	{
		getViewConfig(mTvTitle).setTextColorNormal(Color.WHITE).setTextColorSelected(mLibraryConfig.getmMainColor());
