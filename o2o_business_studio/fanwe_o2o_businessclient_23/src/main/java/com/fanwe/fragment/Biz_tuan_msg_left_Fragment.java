...
public class Biz_tuan_msg_left_Fragment extends BaseFragment implements RefreshActListener
{
	...
	{
		mList = (PullToRefreshListView) view.findViewById(R.id.frag_biztuanmsgleft_list);
		...
		mTvError = (TextView) view.findViewById(R.id.frag_biztuanmsgleft_tv_error);
	}

	private void initIntentInfo()
	{
		mCurrentType = getActivity().getIntent().getExtras().getInt(Biz_tuan_msg_Activity.EXTRA_TYPE);
